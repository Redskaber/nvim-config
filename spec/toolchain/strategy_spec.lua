...
-- FIX-P3 (2026-07-15): toolchain.strategy.conflict module deleted (dead code).
-- Removed describe block covering find_applicable(), detect(), resolve(),
-- and Invariant 15 — no production code required conflict.lua.
